...
## Задача :one: :heavy_plus_sign: (Сума и Произведение) :heavy_multiplication_x:
...
## Задача :two: :arrow_down: (Минимум и Максимум) :arrow_up:
...
## Задача :three: :arrow_right: (Преместване) :arrow_left:
...
## Задача :four: :arrows_counterclockwise: (Обръщане) :arrows_counterclockwise:
...
## Задача :five: :id: (Броене на Елементи) :id:
